...
pub(crate) fn build_generate_request(
    ...
    let vllm_tito = consume_vllm_tito(&mut extra_args)?;
    let routed_experts_prompt_start = vllm_tito.routed_experts_prompt_start;
    ...
    let media = if let Some(features) = vllm_tito.features {
